...
export default function LanguageTutor() {
  ...
  const languages = [
    { id: 'en', name: 'Inglés', flag: '🇬🇧', color: 'from-blue-500 to-blue-700', levels: 5 }
  ];
  ...
  const lessons = {
    en: {
      ...
      2: [
        { type: 'multiple', title: 'Números 1', question: '¿Cómo se dice "uno"?', audio: 'One', options: ['One', 'Two', 'Three', 'Four'], correct: 0, hint: 'Primero' },
        { type: 'translate', title: 'Números 2', question: 'Traduce: "Dos"', audio: 'Two', correctAnswer: 'two', hint: 'Después del uno' },
        { type: 'multiple', title: 'Números 3', question: '¿Cómo se dice "tres"?', audio: 'Three', options: ['Two', 'Three', 'Four', 'Five'], correct: 1, hint: 'Entre 2 y 4' },
        { type: 'complete', title: 'Artículos', question: 'This is __ apple', audio: 'This is an apple', options: ['a', 'an', 'the', 'one'], correct: 1, hint: 'Antes de vocal' },
        { type: 'multiple', title: 'Colores 1', question: '¿Cómo se dice "rojo"?', audio: 'Red', options: ['Blue', 'Red', 'Green', 'Yellow'], correct: 1, hint: 'Color de sangre' },
        { type: 'translate', title: 'Colores 2', question: 'Traduce: "Azul"', audio: 'Blue', correctAnswer: 'blue', hint: 'Color del cielo' },
        { type: 'multiple', title: 'Números 4', question: '¿Cómo se dice "cinco"?', audio: 'Five', options: ['Four', 'Five', 'Six', 'Seven'], correct: 1, hint: 'Después del cuatro' },
        { type: 'complete', title: 'Artículos 2', question: 'I have __ car', audio: 'I have a car', options: ['a', 'an', 'the', 'one'], correct: 0, hint: 'Antes de consonante' },
        { type: 'translate', title: 'Números 5', question: 'Traduce: "Diez"', audio: 'Ten', correctAnswer: 'ten', hint: 'Después del nueve' },
        { type: 'listening', title: 'Escucha', question: 'Escucha y escribe:', audio: 'I love you', correctAnswer: 'i love you', hint: 'Tres palabras de amor' }
      ],
      3: [
        { type: 'translate', title: 'Presentación', question: 'Traduce: "Me llamo María"', audio: 'My name is Maria', correctAnswer: 'my name is maria', hint: 'My name is...' },
        { type: 'complete', title: 'Preguntas', question: '__ are you?', audio: 'How are you', options: ['How', 'What', 'Where', 'Who'], correct: 0, hint: '¿Cómo...?' },
        { type: 'multiple', title: 'Familia 1', question: '¿Cómo se dice "madre"?', audio: 'Mother', options: ['Father', 'Mother', 'Brother', 'Sister'], correct: 1, hint: 'Mamá formal' },
        { type: 'translate', title: 'Familia 2', question: 'Traduce: "Padre"', audio: 'Father', correctAnswer: 'father', hint: 'Papá formal' },
        { type: 'multiple', title: 'Ubicación', question: '¿Cómo se dice "¿Dónde?"', audio: 'Where', options: ['Where', 'When', 'Why', 'Who'], correct: 0, hint: 'Lugar' },
        { type: 'complete', title: 'Verbo to be 2', question: 'She __ beautiful', audio: 'She is beautiful', options: ['am', 'is', 'are', 'be'], correct: 1, hint: 'Tercera persona' },
        { type: 'translate', title: 'Edad', question: 'Traduce: "Tengo 25 años"', audio: 'I am 25 years old', correctAnswer: 'i am 25 years old', hint: 'I am...' },
        { type: 'multiple', title: 'Ocupación', question: '¿Cómo se dice "trabajo"?', audio: 'Work', options: ['Work', 'Play', 'Study', 'Rest'], correct: 0, hint: 'Actividad laboral' },
        { type: 'complete', title: 'Preguntas 2', question: '__ old are you?', audio: 'How old are you', options: ['How', 'What', 'Where', 'When'], correct: 0, hint: 'Edad' },
        { type: 'listening', title: 'Escucha', question: 'Escucha y escribe:', audio: 'Nice to meet you', correctAnswer: 'nice to meet you', hint: 'Al conocer a alguien' }
      ],
      4: [
        { type: 'translate', title: 'Presente Simple', question: 'Traduce: "Yo trabajo todos los días"', audio: 'I work every day', correctAnswer: 'i work every day', hint: 'I work...' },
        { type: 'complete', title: 'Presente Simple 2', question: 'She __ to school', audio: 'She goes to school', options: ['go', 'goes', 'going', 'went'], correct: 1, hint: 'Tercera persona añade -es' },
        { type: 'multiple', title: 'Tiempo', question: '¿Cómo se dice "ayer"?', audio: 'Yesterday', options: ['Today', 'Yesterday', 'Tomorrow', 'Now'], correct: 1, hint: 'Pasado' },
        { type: 'translate', title: 'Pasado Simple', question: 'Traduce: "Yo comí pizza"', audio: 'I ate pizza', correctAnswer: 'i ate pizza', hint: 'I ate...' },
        { type: 'complete', title: 'Pasado Simple 2', question: 'They __ a movie yesterday', audio: 'They watched a movie yesterday', options: ['watch', 'watches', 'watched', 'watching'], correct: 2, hint: 'Pasado regular -ed' },
        { type: 'multiple', title: 'Frecuencia', question: '¿Cómo se dice "siempre"?', audio: 'Always', options: ['Always', 'Never', 'Sometimes', 'Often'], correct: 0, hint: 'Todo el tiempo' },
        { type: 'translate', title: 'Futuro', question: 'Traduce: "Iré mañana"', audio: 'I will go tomorrow', correctAnswer: 'i will go tomorrow', hint: 'I will...' },
        { type: 'complete', title: 'Presente Continuo', question: 'I __ studying now', audio: 'I am studying now', options: ['am', 'is', 'are', 'be'], correct: 0, hint: 'To be + -ing' },
        { type: 'multiple', title: 'Conectores', question: '¿Cómo se dice "porque"?', audio: 'Because', options: ['Because', 'But', 'And', 'Or'], correct: 0, hint: 'Para explicar' },
        { type: 'listening', title: 'Escucha', question: 'Escucha y escribe:', audio: 'What are you doing', correctAnswer: 'what are you doing', hint: 'Pregunta presente continuo' }
      ],
      5: [
        { type: 'translate', title: 'Condicional', question: 'Traduce: "Si tuviera dinero, compraría una casa"', audio: 'If I had money I would buy a house', correctAnswer: 'if i had money i would buy a house', hint: 'If I had... I would...' },
        { type: 'complete', title: 'Pasado Perfecto', question: 'I __ already eaten', audio: 'I had already eaten', options: ['have', 'has', 'had', 'having'], correct: 2, hint: 'Pasado de have' },
        { type: 'multiple', title: 'Vocabulario', question: '¿Qué significa "although"?', audio: 'Although', options: ['Aunque', 'Porque', 'Entonces', 'Además'], correct: 0, hint: 'Contraste' },
        { type: 'translate', title: 'Voz Pasiva', question: 'Traduce: "La casa fue construida"', audio: 'The house was built', correctAnswer: 'the house was built', hint: 'Was + participio' },
        { type: 'complete', title: 'Reported Speech', question: 'She said she __ tired', audio: 'She said she was tired', options: ['is', 'was', 'be', 'been'], correct: 1, hint: 'Pasado indirecto' },
        { type: 'multiple', title: 'Phrasal Verbs', question: '¿Qué significa "give up"?', audio: 'Give up', options: ['Rendirse', 'Levantarse', 'Seguir', 'Empezar'], correct: 0, hint: 'Dejar de intentar' },
        { type: 'translate', title: 'Subjuntivo', question: 'Traduce: "Es importante que estudies"', audio: 'It is important that you study', correctAnswer: 'it is important that you study', hint: 'It is important that...' },
        { type: 'complete', title: 'Modales', question: 'You __ have told me', audio: 'You should have told me', options: ['should', 'must', 'can', 'will'], correct: 0, hint: 'Deber pasado' },
        { type: 'multiple', title: 'Expresiones', question: '¿Qué significa "piece of cake"?', audio: 'Piece of cake', options: ['Muy fácil', 'Pastel', 'Difícil', 'Aburrido'], correct: 0, hint: 'Idiom común' },
        { type: 'listening', title: 'Escucha', question: 'Escucha y escribe:', audio: 'Had I known I would have helped', correctAnswer: 'had i known i would have helped', hint: 'Condicional complejo' }
      ]
    }
  };
  ...
  const getRandomMessage = (type, customStreak = null) => {
    ...
    return randomMsg.replace('{name}', userName).replace('{streak}', customStreak || streak);
  };
  ...
  const updateLevelProgress = (langId, level, score, total) => {
    const key = `${langId}_${level}`;
    const stars = score === total ? 3 : score >= total * 0.8 ? 2 : score >= total * 0.6 ? 1 : 0;
    const newProgress = {
      ...userProgress,
      [key]: { completed: true, score, total, stars, lastCompleted: new Date().toISOString() }
    };
  ...
  const handleAnswer = (index) => {
    ...
    if (isCorrect) {
      ...
      setStreak(newStreak);
      setEncouragementMessage(newStreak >= 3 ? getRandomMessage('streak', newStreak) : getRandomMessage('correct'));
    } else {
      setStreak(0);
  ...
  const handleTextSubmit = () => {
    ...
    const currentLessonData = lessons[selectedLanguage.id][currentLevel][currentLesson];
    const isCorrect = textInput.toLowerCase().trim() === currentLessonData.correctAnswer.toLowerCase().trim();
  ...
  const nextLesson = () => {
    const totalLessons = lessons[selectedLanguage.id][currentLevel].length;
    if (currentLesson < totalLessons - 1) {
      ...
      updateLevelProgress(selectedLanguage.id, currentLevel, score, totalLessons);
      setScreen('results');
    }
  };
        ...
        <div className="max-w-md mx-auto w-full">
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg">¿Cómo te gustaría que te llame?</p>
            </div>
            ...
            <div className="space-y-4">
              <input
                ...
                onKeyPress={(e) => e.key === 'Enter' && userName.trim() && setScreen('home')}
              ...
              <button
                onClick={() => userName.trim() && setScreen('home')}
        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl p-4 mb-6 mt-4">
            <div className="flex items-center justify-between mb-3">
              <div>
                <h2 className="text-2xl font-bold text-white">¡Hola, {userName}! 👋</h2>
                <p className="text-white text-sm opacity-90">Sigue aprendiendo hoy</p>
              </div>
              <button
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="bg-white bg-opacity-30 rounded-xl px-4 py-2 flex items-center gap-2">
                ...
                <span className="text-white font-bold">
                  {Object.values(userProgress).filter(p => p.completed).length} completados
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-6 mb-4">
            ...
            <div className="space-y-3">
              {languages.map((lang) => {
                const completedLevels = Array.from({ length: lang.levels }, (_, i) => i + 1)
                  .filter(level => getLevelProgress(lang.id, level).completed).length;
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div className="text-left">
                          ...
                          <span className="text-sm opacity-90">{completedLevels}/{lang.levels} niveles · 50 lecciones</span>
                        </div>
                      </div>
          ...
          <div className="bg-white bg-opacity-20 rounded-2xl p-4 text-white text-center backdrop-blur-sm">
            ...
            <p className="text-sm font-semibold">✨ Practica 10 min diarios para mejores resultados</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-500 to-pink-500 p-4">
        <div className="max-w-md mx-auto">
          <div className="flex items-center justify-between mb-6 pt-4">
            <button onClick={resetToHome} className="text-white font-semibold">
              ← Volver
            </button>
          ...
          <div className="text-center mb-6">
            <span className="text-6xl mb-3 block animate-bounce">{selectedLanguage.flag}</span>
            <h1 className="text-3xl font-bold text-white mb-2">{selectedLanguage.name}</h1>
            <p className="text-white opacity-90">Selecciona un nivel</p>
          </div>

          <div className="space-y-4">
            {Array.from({ length: selectedLanguage.levels }, (_, i) => i + 1).map(level => {
              const progress = getLevelProgress(selectedLanguage.id, level);
              const unlocked = isLevelUnlocked(selectedLanguage.id, level);
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3">
                      {unlocked ? (
                        <div className={`p-3 rounded-full text-3xl ${progress.completed ? 'bg-green-100' : 'bg-purple-100'}`}>
                      ...
                      <div className="text-left">
                        <h3 className="text-xl font-bold text-gray-800">Nivel {level} · {levelInfo.name}</h3>
                        <p className="text-sm text-gray-600">
                          {progress.completed 
                            ? `Completado: ${progress.score}/${progress.total}` 
                            : unlocked 
                              ? `${lessons[selectedLanguage.id][level]?.length || 0} lecciones · ${levelInfo.desc}`
                              : 'Bloqueado'}
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="flex gap-1">
                        {Array.from({ length: 3 }).map((_, i) => (
                          <Star
                            key={i}
                            className={`w-5 h-5 ${
                              i < progress.stars ? 'text-yellow-500 fill-yellow-500' : 'text-gray-300'
                            }`}
                          />
                        ))}
                      </div>
  ...
  if (screen === 'lessons' && selectedLanguage) {
    ...
    const getLessonIcon = (type) => {
      switch(type) {
        case 'multiple': return <MessageSquare className="w-5 h-5" />;
        case 'translate': return <Type className="w-5 h-5" />;
        case 'complete': return <BookOpen className="w-5 h-5" />;
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 p-4 pb-8">
        <div className="max-w-md mx-auto">
          <div className="flex items-center justify-between mb-4 pt-4">
            <button onClick={() => setScreen('levels')} className="text-white font-semibold">
              ← Niveles
            </button>
            <div className="flex items-center gap-3">
              {streak >= 3 && (
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-6 mb-4">
            <div className="text-center mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-800 mb-3">{currentLessonData.title}</h2>
              <p className="text-gray-600 text-lg">{currentLessonData.question}</p>
            </div>
            ...
            {(currentLessonData.type === 'listening' && !showResult) && (
              <div className="flex justify-center mb-6">
                ...
                >
                  ...
                  <span className="font-semibold text-lg">🔊 Escuchar</span>
                </button>
              </div>
            )}
            ...
            {showResult && (
              <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-6 mb-6 text-center shadow-lg">
                <p className="text-white text-sm mb-2 opacity-90 font-semibold">✅ Respuesta correcta:</p>
                <div className="flex items-center justify-center mb-2">
                  ...
                  <p className="text-white text-3xl font-bold">{currentLessonData.audio}</p>
                </div>
              </div>
            )}

            {(currentLessonData.type === 'multiple' || currentLessonData.type === 'complete') && (
              <div className="space-y-3">
                  ...
                  return (
                    <button
                      ...
                      className={`w-full p-4 rounded-xl font-semibold text-lg transition-all transform active:scale-95 flex items-center justify-between
                        ${showCorrect ? 'bg-green-500 text-white shadow-lg scale-105' : ''}
                        ${showIncorrect ? 'bg-red-500 text-white shadow-lg' : ''}
                        ${!showResult ? 'bg-gradient-to-r from-gray-50 to-gray-100 text-gray-800 hover:from-purple-50 hover:to-pink-50 shadow-md hover:shadow-lg border-2 border-transparent hover:border-purple-300' : ''}
                        ${showResult && !isSelected && !isCorrect ? 'bg-gray-100 text-gray-400' : ''}
                      `}
                    >
                      <span>{option}</span>
                      {showCorrect && <Check className="w-6 h-6 animate-bounce" />}
            ...
            {(currentLessonData.type === 'translate' || currentLessonData.type === 'listening') && (
              <div className="space-y-4">
                <input
                  type="text"
                  value={textInput}
                  ...
                  className={`w-full p-4 rounded-xl text-lg border-2 focus:outline-none transition-all
                    ${showResult 
                      ? textInput.toLowerCase().trim() === currentLessonData.correctAnswer.toLowerCase().trim()
            ...
            {!showResult && (
              <div className="mt-6">
                ...
                >
                  {showHint ? '🙈 Ocultar Pista' : `💡 ¿Necesitas ayuda, ${userName}?`}
                </button>
                {showHint && (
                  <div className="mt-3 p-4 bg-yellow-50 border-2 border-yellow-300 rounded-xl">
                    <p className="text-yellow-900 text-center font-medium">💡 {currentLessonData.hint}</p>
                  </div>
                )}
              </div>
            )}
            ...
            {showResult && (
              <button
                ...
                className="w-full mt-6 bg-gradient-to-r from-green-500 to-green-600 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-105 active:scale-95"
              >
                {currentLesson < totalLessons - 1 ? `Siguiente, ${userName}! →` : `Ver Resultados 🏆`}
              </button>
            )}
          </div>
        </div>
  ...
  if (screen === 'results') {
    ...
    const stars = score === totalLessons ? 3 : score >= totalLessons * 0.8 ? 2 : score >= totalLessons * 0.6 ? 1 : 0;
        ...
        <div className="max-w-md mx-auto w-full">
          <div className="bg-white rounded-3xl shadow-2xl p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-600 text-lg mb-2 font-semibold">{personalMessage}</p>
              <p className="text-gray-500">Nivel {currentLevel} - {selectedLanguage.name}</p>
            </div>

            <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl p-6 mb-6 shadow-lg">
              <p className="text-white text-7xl font-bold mb-2">{percentage}%</p>
              <p className="text-white text-xl mb-3">Puntaje: {score}/{totalLessons}</p>
              <div className="flex justify-center gap-2">
                {Array.from({ length: 3 }).map((_, i) => (
                  <Star
                    key={i}
                    className={`w-8 h-8 ${
                      i < stars ? 'text-yellow-300 fill-yellow-300 animate-pulse' : 'text-white opacity-30'
                    }`}
                  />
                ))}
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-green-100 p-4 rounded-xl border-2 border-green-300">
                ...
                <div className="text-green-600 text-3xl font-bold">{score}</div>
                <div className="text-green-800 text-sm font-semibold">Correctas</div>
              </div>
              <div className="bg-red-100 p-4 rounded-xl border-2 border-red-300">
                <X className="w-8 h-8 text-red-600 mx-auto mb-1" />
                <div className="text-red-600 text-3xl font-bold">{totalLessons - score}</div>
                <div className="text-red-800 text-sm font-semibold">Incorrectas</div>
              </div>
            </div>

            <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-2 border-purple-200 rounded-xl p-4 mb-6">
              <Award className="w-8 h-8 text-purple-600 mx-auto mb-2" />
              <p className="text-purple-800 font-bold text-lg">+{score * 10} puntos</p>
              <p className="text-purple-600 text-sm">Total acumulado: {totalScore} pts</p>
            </div>
